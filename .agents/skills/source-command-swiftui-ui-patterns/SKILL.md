---
name: "source-command-swiftui-ui-patterns"
...
# source-command-swiftui-ui-patterns

Use this skill when the user asks to run the migrated source command `swiftui-ui-patterns`.

      ...
      <div className="border-t border-sidebar-border p-2 space-y-1">
        ...
        {onLogout ? (
          <button
            type="button"
            onClick={onLogout}
            className="flex w-full items-center gap-2.5 rounded-md px-2.5 py-2 text-[13px] text-sidebar-foreground-muted hover:bg-sidebar-hover-bg hover:text-sidebar-foreground transition-colors"
          >
            <LogoutIcon />
            <span>Log out</span>
          </button>

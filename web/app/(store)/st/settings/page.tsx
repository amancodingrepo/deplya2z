            ...
            <form onSubmit={handleProfileSave}>
              <CardContent className="flex flex-col gap-4">
                <div className="flex items-center gap-4">
                  <Avatar name={name || 'ST'} size="lg" />
                  <div>
                    <p className="text-[13px] font-semibold">{name}</p>
                    <p className="text-[12px] text-muted-foreground">
                      Store Manager · {user?.location_code ?? '—'}
                    </p>
                  </div>
                </div>
          ...
          <Card>
            ...
            <CardContent className="flex flex-col gap-2">
              <div className="rounded-md bg-muted/50 p-3">
                <p className="text-[13px] font-medium">{user?.location_name ?? 'My Store'}</p>
                <p className="text-[12px] text-muted-foreground">{user?.location_code ?? '—'} · Store</p>
              </div>
              <p className="text-[12px] text-muted-foreground">Contact admin to update store details.</p>
            </CardContent>
          </Card>
        </div>
      </div>
